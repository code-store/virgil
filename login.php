    ...
    <div class="login-inner">
      <div class="login">
        ...
        <form class="form" method="post" action="checklogin.php" >
          ...
          <div class="password"><input name="mypassword" id="mypassword" type="password" onblur="if(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value=='password')this.value='';" value="password"  /></div>
          <div class="log-btn"><input name="" value="<?php echo $lang_array['Login']; ?>" type="submit" /></div>
          <div class="forget"><a href="./forgot_pass.php"><?php echo $lang_array['Forget your password?'] ?></a></div>
        </form>
      </div>
    </div>
  </div>
