...
.form-list li { margin: 0 0 8px !important; width: 500px !important;}
.form-list li.fields .field{ width:100% !important; margin:4px 0 !important; }
.form-list li.fields .field label{ width:150px; float:left; }
.form-list li.fields .field .input-box{ width:330px; float:left; }
.form-list li.fields .field input[type="text"]{width:95%; height:30px; border:1px solid #e4e4e4; padding:3px; font:12px Arial, Helvetica, sans-serif; color:#585858; background:#fff; box-shadow:none; margin:0 !important; }
.form-list li.fields .field select{width:97%; height:38px; border:1px solid #e4e4e4; padding:9px 6px; font:12px Arial, Helvetica, sans-serif; color:#585858; background:#fff; box-shadow:none; margin:0 !important; }
	   ...
	   <?php } ?>    
		  ...
		  ?>
			<div class="log-btn-con">
				<input type="submit" value="Submit" name="submit" style="margin-left:169px; cursor:pointer;">
			</div>
		</div>
	   </form> 
	</ul>
