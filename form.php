...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
        	...
        	.newsletter-form fieldset{width:52% !important; float:left !important;}
        	.newsletter-form fieldset .form-list{float:none  !important;}
        	.newsletter-form fieldset .form-list li{width:100% !important;}
        	.newsletter-form fieldset .form-list li .field{width:100% !important;float:none  !important;}
        	.newsletter-form fieldset .form-list .field label{float:none  !important;}
        	
        	.newsletter-form fieldset .form-list li.fields .field input[type=text]{width:95% !important; height:32px !important;}
        	.newsletter-form .log-btn input[type=submit] {width:135px !important;  
        	 float:right !important; height:50px !important; background: url("images/inbox2.jpg") no-repeat scroll left top rgba(0, 0, 0, 0) !important;  }
        	.newsletter-form .log-btn{margin-top:18px !important;
	}
}
        ...
        <body>
            ...
            <ul class="product_list" id="theContent" style="padding:0px;">
                ...
                $adminEmail = 'testingmyssite@gmail.com';
                ...
                if (isset($_POST['submit']) && $_POST['submit'] == 'Submit') {
                    ...
                    if (!$resp->is_valid) {
                        if ($resp->error == 'incorrect-captcha-sol') {
                            $errors = 'The captcha you filled out did not match the image. Please try again.';
                        }
                    }
                    */
                    if ($errors == '') {
                ...
                <?php } ?>
                    <div <?php if($formId == 24) { echo 'class="newsletter-form"'; } ?>>
                <?php
                $sqlFieldsets = "SELECT * FROM form_fieldsets WHERE form_id='" . $formId . "' AND status='1' order by position";
                $resultFieldsets = mysql_query($sqlFieldsets) or die(mysql_error());
                while ($rowFieldsets = mysql_fetch_array($resultFieldsets)) {
    ...
    ?>
            ...
            while ($rowFieldsets = mysql_fetch_array($resultFieldsets)) {
                $nrSteps++;
                if ($nrSteps == 1) {
                    echo "<div id='tabs-" . $nrSteps . "' style='display:block;'>";
                } else {
                    echo "<div id='tabs-" . $nrSteps . "' style='display:none;'>";
                }
                ?>
                        <!--<fieldset class="fieldset">-->
                        <div class="fieldset">
